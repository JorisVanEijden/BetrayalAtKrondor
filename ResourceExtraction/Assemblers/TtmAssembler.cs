...
public class TtmAssembler {
    ...
    public static void Assemble(AnimationResource animationResource, string filePath) {
        ...
        writer.Write((ushort)0); // Unknown
        writer.Write(animationResource.NumberOfFrames);
        ...
        writer.Write((ushort)0); // Unknown
        writer.Write((ushort)animationResource.Scenes.Count); // Number of tags

        foreach (var tagEntry in animationResource.Scenes) {
